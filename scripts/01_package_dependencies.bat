...
REM Managed package - Lightweight - JSON Util@0.2.0-1
sf package install --package 04tP30000007y99IAA -w 30

REM ----------------- OPTIONAL BUT ADVICED -----------------
REM Managed package - Lightweight - Data Cloud Auth Provider@0.3.0-1
sf package install --package 04tP30000007slFIAQ -w 30

REM Managed package - Lightweight - Auth Provider Util v2@0.6.0-1
sf package install --package 04tP30000007t1NIAQ -w 30
...
REM Managed package - Lightweight - JSON Util (Unlocked)@0.2.0-1
sf package install --package 04tP30000007yfNIAQ -w 30
